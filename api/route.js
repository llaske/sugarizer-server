...
module.exports = function (app, ini, db) {
	...
	app.put("/api/v1/assignments/launch/:assignmentId", auth.allowedRoles([Admin, Teacher]), assignments.launchAssignment);
	...
	app.put("/api/v1/assignments/deliveries/submit/:assignmentId", auth.allowedRoles([Admin, Teacher]), assignments.submitAssignment);
	// Register classroom API
