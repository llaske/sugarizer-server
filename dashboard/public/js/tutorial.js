			...
			function sugarizerTour(currentView, role, mode) {
				...
				tutorial.init = function () {
					if (currentView == "home") {
						...
						steps.push(getStep("stats", "", "bottom", 1, true));
						steps.push(getStep("stats", "#stats-addChart", "left", 2));
						steps.push(getStep("stats", "#stats-listCharts", "left", 3));
					} else if (currentView == "listCharts") {
						steps.push(getStep("listCharts", "", "bottom", 1, true));
						steps.push(getStep("listCharts", "#listCharts-chartList", "left", 2));
						steps.push(getStep("listCharts", "#listCharts-viewCharts", "left", 3));
						steps.push(getStep("listCharts", "#listCharts-addChart", "left", 4));
						steps.push(getStep("listCharts", "#listCharts-searchbox", "bottom", 5));
						steps.push(getStep("listCharts", "#listCharts-card", "bottom", 6));
						steps.push(getStep("listCharts", "#listCharts-draggable", "right", 7));
						steps.push(getStep("listCharts", "#listCharts-toggleBox", "left", 8));
						steps.push(getStep("listCharts", "#listCharts-editChart", "left", 9));
						steps.push(getStep("listCharts", "#listCharts-deleteChart", "left", 10));
					} else if (currentView == "editUser") {
						steps.push(getStep("editUser", "", "bottom", 1, true));
						steps.push(getStep("editUser", "#editUser-name", "right", 2));
						steps.push(getStep("editUser", "#editUser-language", "right", 3));
						steps.push(getStep("editUser", "#editUser-role", "right", 4));
						steps.push(getStep("editUser", "#editUser-colors", "right", 5));
						steps.push(getStep("editUser", "#editUser-password", "right", 6));
						steps.push(getStep("editUser", "#searchable-select-classrooms-row", "right", 7));
						steps.push(getStep("editUser", "#editUser-twoFactor", "right", 8));
						steps.push(getStep("editUser", "#editUser-created", "right", 9));
						steps.push(getStep("editUser", "#editUser-lastseen", "right", 10));
					} else if (currentView == "editClassroom") {
						steps.push(getStep("editClassroom", "", "bottom", 1, true));
						steps.push(getStep("editClassroom", "#editClassroom-name", "right", 2));
						steps.push(getStep("editClassroom", "#editClassroom-students", "right", 3));
						steps.push(getStep("editClassroom", "#editClassroom-colors", "right", 4));
						steps.push(getStep("editClassroom", "#editClassroom-created", "right", 5));
						steps.push(getStep("editClassroom", "#editClassroom-lastupdated", "right", 6));
					} else if (currentView == "editAssignment") {
						steps.push(getStep("editAssignment", "", "bottom", 1, true));
						steps.push(getStep("editAssignment", "#editAssignment-name", "right", 2));
						steps.push(getStep("editAssignment", "#editAssignment-activity", "right", 3));
						steps.push(getStep("editAssignment", "#editAssignment-instructions", "right", 4));
						steps.push(getStep("editAssignment", "#editAssignment-duedate", "right", 5));
						steps.push(getStep("editAssignment", "#searchable-select-classrooms-row", "right", 6));
					} else if (currentView == "editChart") {
						steps.push(getStep("editChart", "", "bottom", 1, true));
						steps.push(getStep("editChart", "#editChart-title", "right", 2));
						steps.push(getStep("editChart", "#editChart-type", "right", 3));
						steps.push(getStep("editChart", "#editChart-selectchart", "right", 4));
