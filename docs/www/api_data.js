define({ "api": [
  ...
  },
  {
    ...
    "title": "Signup User",
    "name": "Signup_User",
    "description": "<p>Add a new user (Admin or Student). Return the user created.</p> <p>For security reason, call to signup for an Admin is only allowed from the server address.</p>",
    "group": "Auth",
    "version": "1.0.0",
    "success": {
      "fields": {
